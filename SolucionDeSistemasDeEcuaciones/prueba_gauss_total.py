import numpy as np
import gauss_pivoteo_total

def despejar_total(A,b, marcas):
    (A,b, marcas) = gauss_pivoteo_total.gauss_pivoteo_total(A,b, marcas) #Escalonar A
    n = len(A)-1
