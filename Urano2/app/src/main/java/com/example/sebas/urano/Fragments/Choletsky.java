 ...
 */
public class Choletsky extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        inflaterView = inflater.inflate(R.layout.fragment_choletsky,
                container, false);
    ...
    public void help(){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getActivity(), AyudaCholesky.class));
            }
        });
    }
}
